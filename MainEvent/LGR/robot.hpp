...
namespace LGR {
  struct Robot {
    ...
    const double squareSumArmLen = innerArmLen*innerArmLen + outerArmLen*outerArmLen;
  ...
  void Robot::print() {
    cout << "Motor Angles: 1 - " << Motor1Angle << ", 2 - " << Motor2Angle << endl << "X Destination: " << DestX << ", Y Destination: " << DestY << endl;
  }
