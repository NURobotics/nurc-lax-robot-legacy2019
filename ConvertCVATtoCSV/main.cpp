...
int main()
{
    string files[] = {"8M_TightLeft_1", "8M_Center_3", "8M_TightLeft", "8M_TightLeft_1", "8M_TightRight", "8M_TightRight_1", "8M_TightRight_2", "4M_Center", "4M_Center_1"};

    for (string file : files) {
        int n = file.length() + 4;
        char char_array[n + 1];
        strcpy(char_array, string(file + ".xml").c_str());
