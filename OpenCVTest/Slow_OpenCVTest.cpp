...
VideoWriter outLeft("/media/nvidia/USB32/OCT_23/FootageL/VID_0.avi", VideoWriter::fourcc('M', 'J', 'P', 'G'), 60, S);
VideoWriter outRight("/media/nvidia/USB32/OCT_23/FootageR/VID_0.avi", VideoWriter::fourcc('M', 'J', 'P', 'G'), 60, S);
        ...
        switch (r) {
          ...
          case 2:
            if (!toSaveLeft.empty()) {
              ...
              if (currSave.empty()) {
                cout << "/media/nvidia/USB32/OCT_23/FootageL/" + nameL + ".avi Completed" << endl;
                toSaveLeft.pop();
                outLeft.release();
                ...
                string vidName = "/media/nvidia/USB32/OCT_23/FootageL/" + nameL + ".avi";
          ...
          case 3:
            if (!toSaveRight.empty()) {
              ...
              if (currSave.empty()) {
                cout << "/media/nvidia/USB32/OCT_23/FootageR/" + nameR + ".avi Completed" << endl;
                toSaveRight.pop();
                outRight.release();
                ...
                string vidName = "/media/nvidia/USB32/OCT_23/FootageR/" + nameR + ".avi";
